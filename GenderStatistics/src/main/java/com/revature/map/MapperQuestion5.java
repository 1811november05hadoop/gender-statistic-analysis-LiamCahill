...
public class MapperQuestion5 extends Mapper<LongWritable, Text, Text, DoubleWritable> {
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		if(line.contains("Age at first marriage, female") && line.contains("SP.DYN.SMAM.FE") && line.contains("United States")) {
